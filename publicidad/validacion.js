...
function validarFormulario() { 
	...
	if(!document.getElementById('diseño').checked && !document.getElementById('salon').checked && !document.getElementById('catering').checked && !document.getElementById('musica').checked && !document.getElementById('social').checked)
	...
	opciones = document.getElementsByName("evento");
	...
	if(!seleccionado) {
	alert('No se ha seleccionado franja horaria del evento');
  	return false;
	}
