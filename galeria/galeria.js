...
var foto = new Array();
foto[0] = "img/exterior-zoologico.jpg";
foto[1] = "img/parque-chacabuco-escaleras.jpg";
foto[2] = "img/parque-de-la-memoria.jpg";
foto[3] = "img/parque-chacabuco-sendero.jpg";
foto[4] = "img/plaza-francisco-seeber.jpg";
foto[5] = "img/laza-sicilia.jpg";



var texto = new Array();
texto[0] = "Exterior Zoológico";
texto[1] = "Escaleras del parque chacabuco";
texto[2] = "Parque de la memoria";
texto[3] = "Sendero del parque Chacabuco";
texto[4] = "Plaza Francosco Seeber";
texto[5] = "Plaza Sicilia";
